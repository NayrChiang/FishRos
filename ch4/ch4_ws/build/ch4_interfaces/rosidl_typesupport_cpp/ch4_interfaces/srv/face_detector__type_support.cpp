...
static const _FaceDetector_Request_type_support_symbol_names_t _FaceDetector_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ch4_interfaces, srv, FaceDetector_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ch4_interfaces, srv, FaceDetector_Request)),
  }
};
...
{
  return &::ch4_interfaces::srv::rosidl_typesupport_cpp::FaceDetector_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ch4_interfaces, srv, FaceDetector_Request)() {
  return get_message_type_support_handle<ch4_interfaces::srv::FaceDetector_Request>();
}
...
static const _FaceDetector_Response_type_support_symbol_names_t _FaceDetector_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ch4_interfaces, srv, FaceDetector_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ch4_interfaces, srv, FaceDetector_Response)),
  }
};
...
{
  return &::ch4_interfaces::srv::rosidl_typesupport_cpp::FaceDetector_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ch4_interfaces, srv, FaceDetector_Response)() {
  return get_message_type_support_handle<ch4_interfaces::srv::FaceDetector_Response>();
}
...
static const _FaceDetector_type_support_symbol_names_t _FaceDetector_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ch4_interfaces, srv, FaceDetector)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ch4_interfaces, srv, FaceDetector)),
  }
};
...
{
  return &::ch4_interfaces::srv::rosidl_typesupport_cpp::FaceDetector_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ch4_interfaces, srv, FaceDetector)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ch4_interfaces::srv::FaceDetector>();
}

...
static const _Patrol_Request_type_support_symbol_names_t _Patrol_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ch4_interfaces, srv, Patrol_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ch4_interfaces, srv, Patrol_Request)),
  }
};
...
get_message_type_support_handle<ch4_interfaces::srv::Patrol_Request>()
{
  return &::ch4_interfaces::srv::rosidl_typesupport_cpp::Patrol_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ch4_interfaces, srv, Patrol_Request)() {
  return get_message_type_support_handle<ch4_interfaces::srv::Patrol_Request>();
}
...
static const _Patrol_Response_type_support_symbol_names_t _Patrol_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ch4_interfaces, srv, Patrol_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ch4_interfaces, srv, Patrol_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<ch4_interfaces::srv::Patrol_Response>()
{
  return &::ch4_interfaces::srv::rosidl_typesupport_cpp::Patrol_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ch4_interfaces, srv, Patrol_Response)() {
  return get_message_type_support_handle<ch4_interfaces::srv::Patrol_Response>();
}
...
static const _Patrol_type_support_symbol_names_t _Patrol_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ch4_interfaces, srv, Patrol)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ch4_interfaces, srv, Patrol)),
  }
};
...
get_service_type_support_handle<ch4_interfaces::srv::Patrol>()
{
  return &::ch4_interfaces::srv::rosidl_typesupport_cpp::Patrol_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ch4_interfaces, srv, Patrol)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ch4_interfaces::srv::Patrol>();
}

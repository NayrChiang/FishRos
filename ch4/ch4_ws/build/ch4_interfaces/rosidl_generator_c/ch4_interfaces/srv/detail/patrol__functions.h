...
#ifndef CH4_INTERFACES__SRV__DETAIL__PATROL__FUNCTIONS_H_
#define CH4_INTERFACES__SRV__DETAIL__PATROL__FUNCTIONS_H_
 ...
 * calls
 * ch4_interfaces__srv__Patrol_Request__init().
...
/**
 * It calls
 * ch4_interfaces__srv__Patrol_Request__fini()
 ...
 * ch4_interfaces__srv__Patrol_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ch4_interfaces__srv__Patrol_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ch4_interfaces__srv__Patrol_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ch4_interfaces
...
/**
 * It calls
 * ch4_interfaces__srv__Patrol_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ch4_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ch4_interfaces__srv__Patrol_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ch4_interfaces
...
/**
 * It calls
 * ch4_interfaces__srv__Patrol_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CH4_INTERFACES__SRV__DETAIL__PATROL__FUNCTIONS_H_

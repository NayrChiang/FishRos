...
protected:
  ...
  // Store transform buffer pointer for querying coordinate relationships
  ...
  // Get the nearest point in the path to the current point
  geometry_msgs::msg::PoseStamped
  getNearestTargetPose(const geometry_msgs::msg::PoseStamped &current_pose);
  // Calculate angle difference between target direction and current position
  double
